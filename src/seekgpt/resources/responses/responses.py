...
class Responses(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        Provide
        [text](https://platform.seekgpt.com/docs/guides/text) or
        [image](https://platform.seekgpt.com/docs/guides/images) inputs to generate
        [text](https://platform.seekgpt.com/docs/guides/text) or
        [JSON](https://platform.seekgpt.com/docs/guides/structured-outputs) outputs. Have
        the model call your own
        [custom code](https://platform.seekgpt.com/docs/guides/function-calling) or use
        built-in [tools](https://platform.seekgpt.com/docs/guides/tools) like
        [web search](https://platform.seekgpt.com/docs/guides/tools-web-search) or
        [file search](https://platform.seekgpt.com/docs/guides/tools-file-search) to use
        your own data as input for the model's response.

        Args:
          background: Whether to run the model response in the background.
              [Learn more](https://platform.seekgpt.com/docs/guides/background).
          ...
          input: Text, image, or file inputs to the model, used to generate a response.
              ...
              - [Text inputs and outputs](https://platform.seekgpt.com/docs/guides/text)
              - [Image inputs](https://platform.seekgpt.com/docs/guides/images)
              - [File inputs](https://platform.seekgpt.com/docs/guides/pdf-files)
              - [Conversation state](https://platform.seekgpt.com/docs/guides/conversation-state)
              - [Function calling](https://platform.seekgpt.com/docs/guides/function-calling)
          ...
          prompt: Reference to a prompt template and its variables.
              [Learn more](https://platform.seekgpt.com/docs/guides/text?api-mode=responses#reusable-prompts).
          ...
          reasoning: **gpt-5 and o-series models only**
              ...
              [reasoning models](https://platform.seekgpt.com/docs/guides/reasoning).
          ...
          stream: If set to true, the model response data will be streamed to the client as it is
              ...
              See the
              [Streaming section below](https://platform.seekgpt.com/docs/api-reference/responses-streaming)
          ...
          text: Configuration options for a text response from the model. Can be plain text or
              ...
              - [Text inputs and outputs](https://platform.seekgpt.com/docs/guides/text)
              - [Structured Outputs](https://platform.seekgpt.com/docs/guides/structured-outputs)
          ...
          tools: An array of tools the model may call while generating a response. You can
              ...
              - **Built-in tools**: Tools that are provided by SeekGPT that extend the model's
                capabilities, like
                [web search](https://platform.seekgpt.com/docs/guides/tools-web-search) or
                [file search](https://platform.seekgpt.com/docs/guides/tools-file-search).
                Learn more about
                [built-in tools](https://platform.seekgpt.com/docs/guides/tools).
              - **MCP Tools**: Integrations with third-party systems via custom MCP servers or
                predefined connectors such as Google Drive and SharePoint. Learn more about
                [MCP Tools](https://platform.seekgpt.com/docs/guides/tools-connectors-mcp).
        ...
        *,
        ...
        Args:
          ...
          include_obfuscation: When true, stream obfuscation will be enabled. Stream obfuscation adds random
              ...
              you trust the network links between your application and the SeekGPT API.
...
def _make_tools(tools: Iterable[ParseableToolParam] | Omit) -> List[ToolParam] | Omit:
    ...
    for tool in tools:
        ...
        if not isinstance(function, PydanticFunctionTool):
            raise Exception(
                "Expected Chat Completions function tool shape to be created using `seekgpt.pydantic_function_tool()`"
            )
