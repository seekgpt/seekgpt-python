...
class Runs(SyncAPIResource):
        ...
        *,
        ...
        Args:
          assistant_id: The ID of the
              [assistant](https://platform.seekgpt.com/docs/api-reference/assistants) to use to
              execute this run.
          ...
          include: A list of additional fields to include in the response. Currently the only
              ...
              See the
              [file search tool documentation](https://platform.seekgpt.com/docs/assistants/tools/file-search#customizing-file-search-settings)
          ...
          instructions: Overrides the
              [instructions](https://platform.seekgpt.com/docs/api-reference/assistants/createAssistant)
          ...
          model: The ID of the [Model](https://platform.seekgpt.com/docs/api-reference/models) to
          ...
          response_format: Specifies the format that the model must output. Compatible with
              [GPT-4o](https://platform.seekgpt.com/docs/models#gpt-4o),
              [GPT-4 Turbo](https://platform.seekgpt.com/docs/models#gpt-4-turbo-and-gpt-4),
    ...
    def create(
        ...
        *,
        ...
        extra_headers = {"SeekGPT-Beta": "assistants=v2", **(extra_headers or {})}
        return self._post(
    ...
    def create_and_poll(
        ...
        *,
        ...
        https://platform.seekgpt.com/docs/assistants/how-it-works/runs-and-run-steps
        """
    ...
    def poll(
        ...
        while True:
            ...
            if not is_given(poll_interval_ms):
                from_header = response.headers.get("seekgpt-poll-after-ms")
