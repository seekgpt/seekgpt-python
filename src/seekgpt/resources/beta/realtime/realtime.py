    ...
    async def __aenter__(self) -> AsyncRealtimeConnection:
        ...
        **Warning**: You must remember to close the connection with `.close()`.
        ...
        try:
            ...
            raise SeekGPTError("You need to install `seekgpt[realtime]` to use this method") from exc
...
class RealtimeOutputAudioBufferResource(BaseRealtimeConnectionResource):
    def clear(self, *, event_id: str | NotGiven = NOT_GIVEN) -> None:
        ...
        [Learn more](https://platform.seekgpt.com/docs/guides/realtime-conversations#client-and-server-events-for-audio-in-webrtc).
        """
        self._connection.send(
