...
class Webhooks(SyncAPIResource):
    def unwrap(
        ...
        *,
        ...
        """Validates that the given payload was sent by SeekGPT and parses the payload."""
        if secret is None:
    ...
    def verify_signature(
        ...
        *,
        ...
        """Validates whether or not the webhook payload was sent by SeekGPT.
        ...
        if secret is None:
            raise ValueError(
                "The webhook secret must either be set using the env var, SEEKGPT_WEBHOOK_SECRET, "
                "on the client class, SeekGPT(webhook_secret='123'), or passed to this function"
            )
        ...
        # Prepare the signed payload (SeekGPT uses webhookId.timestamp.payload format)
