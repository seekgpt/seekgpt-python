...
class Files(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        [File](https://platform.seekgpt.com/docs/api-reference/files) to a
        [vector store](https://platform.seekgpt.com/docs/api-reference/vector-stores/object).

        Args:
          file_id: A [File](https://platform.seekgpt.com/docs/api-reference/files) ID that the
    ...
    def delete(
        ...
        *,
        ...
        [delete file](https://platform.seekgpt.com/docs/api-reference/files/delete)
        endpoint.
