...
class Moderations(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        Learn more in
        the [moderation guide](https://platform.seekgpt.com/docs/guides/moderation).
        ...
        Args:
          ...
          model: The content moderation model you would like to use. Learn more in
              [the moderation guide](https://platform.seekgpt.com/docs/guides/moderation), and
              learn about available models
              [here](https://platform.seekgpt.com/docs/models#moderation).
