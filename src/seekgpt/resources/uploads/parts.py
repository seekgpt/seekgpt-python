...
class Parts(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        """
        Adds a
        [Part](https://platform.seekgpt.com/docs/api-reference/uploads/part-object) to an
        ...
        [complete the Upload](https://platform.seekgpt.com/docs/api-reference/uploads/complete).
