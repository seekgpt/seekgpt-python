...
log: logging.Logger = logging.getLogger("seekgpt.audio.transcriptions")
        ...
        *,
        ...
        Args:
          ...
          stream: If set to true, the model response data will be streamed to the client as it is
              ...
              See the
              [Streaming section of the Speech-to-Text guide](https://platform.seekgpt.com/docs/guides/speech-to-text?lang=curl#streaming-transcriptions)
          ...
          prompt: An optional text to guide the model's style or continue a previous audio
              segment. The
              [prompt](https://platform.seekgpt.com/docs/guides/speech-to-text#prompting)
