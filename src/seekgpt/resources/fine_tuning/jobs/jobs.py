...
class Jobs(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        [Learn more about fine-tuning](https://platform.seekgpt.com/docs/guides/model-optimization)

        Args:
          model: The name of the model to fine-tune. You can select one of the
              [supported models](https://platform.seekgpt.com/docs/guides/fine-tuning#which-models-can-be-fine-tuned).

          training_file: The ID of an uploaded file that contains training data.

              See [upload file](https://platform.seekgpt.com/docs/api-reference/files/create)
              ...
              [chat](https://platform.seekgpt.com/docs/api-reference/fine-tuning/chat-input),
              [completions](https://platform.seekgpt.com/docs/api-reference/fine-tuning/completions-input)
              format, or if the fine-tuning method uses the
              [preference](https://platform.seekgpt.com/docs/api-reference/fine-tuning/preference-input)
              format.

              See the
              [fine-tuning guide](https://platform.seekgpt.com/docs/guides/model-optimization)
              for more details.
          ...
          suffix: A string of up to 64 characters that will be added to your fine-tuned model
              ...
              `ft:gpt-4o-mini:seekgpt:custom-model-name:7p4lURel`.
