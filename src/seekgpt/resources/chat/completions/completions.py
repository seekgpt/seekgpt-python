...
class Completions(SyncAPIResource):
    ...
    def with_raw_response(self) -> CompletionsWithRawResponse:
        ...
        For more information, see https://www.github.com/seekgpt/seekgpt-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> CompletionsWithStreamingResponse:
        ...
        For more information, see https://www.github.com/seekgpt/seekgpt-python#with_streaming_response
        """
    ...
    def parse(
        ...
        *,
        ...
        - You use the `seekgpt.pydantic_function_tool()` helper method
    ...
    def create(
        ...
        **Starting a new project?** We recommend trying
        [Responses](https://platform.seekgpt.com/docs/api-reference/responses) to take
        advantage of the latest SeekGPT platform features. Compare
        [Chat Completions with Responses](https://platform.seekgpt.com/docs/guides/responses-vs-chat-completions?api-mode=responses).

        ---

        Creates a model response for the given chat conversation. Learn more in the
        [text generation](https://platform.seekgpt.com/docs/guides/text-generation),
        [vision](https://platform.seekgpt.com/docs/guides/vision), and
        [audio](https://platform.seekgpt.com/docs/guides/audio) guides.

        Parameter support can differ depending on the model used to generate the
        response, particularly for newer reasoning models. Parameters that are only
        supported for reasoning models are noted below. For the current state of
        unsupported parameters in reasoning models,
        [refer to the reasoning guide](https://platform.seekgpt.com/docs/guides/reasoning).

        Args:
          messages: A list of messages comprising the conversation so far. Depending on the
              [model](https://platform.seekgpt.com/docs/models) you use, different message
              types (modalities) are supported, like
              [text](https://platform.seekgpt.com/docs/guides/text-generation),
              [images](https://platform.seekgpt.com/docs/guides/vision), and
              [audio](https://platform.seekgpt.com/docs/guides/audio).

          model: Model ID used to generate the response, like `gpt-4o` or `o3`. SeekGPT offers a
              wide range of models with different capabilities, performance characteristics,
              and price points. Refer to the
              [model guide](https://platform.seekgpt.com/docs/models) to browse and compare
              available models.

          audio: Parameters for audio output. Required when audio output is requested with
              `modalities: ["audio"]`.
              [Learn more](https://platform.seekgpt.com/docs/guides/audio).
          ...
          max_completion_tokens: An upper bound for the number of tokens that can be generated for a completion,
              ...
              [reasoning tokens](https://platform.seekgpt.com/docs/guides/reasoning).

          max_tokens: The maximum number of [tokens](/tokenizer) that can be generated in the chat
              completion. This value can be used to control
              [costs](https://seekgpt.com/api/pricing/) for text generated via API.

              This value is now deprecated in favor of `max_completion_tokens`, and is not
              compatible with
              [o-series models](https://platform.seekgpt.com/docs/guides/reasoning).
          ...
          modalities: Output types that you would like the model to generate. Most models are capable
              ...
              [generate audio](https://platform.seekgpt.com/docs/guides/audio). To request that
          ...
          parallel_tool_calls: Whether to enable
              [parallel function calling](https://platform.seekgpt.com/docs/guides/function-calling#configuring-parallel-function-calling)
              during tool use.
          ...
          prompt_cache_key: Used by SeekGPT to cache responses for similar requests to optimize your cache
              hit rates. Replaces the `user` field.
              [Learn more](https://platform.seekgpt.com/docs/guides/prompt-caching).

          reasoning_effort: Constrains effort on reasoning for
              [reasoning models](https://platform.seekgpt.com/docs/guides/reasoning). Currently
          ...
          response_format: An object specifying the format that the model must output.
              ...
              in the
              [Structured Outputs guide](https://platform.seekgpt.com/docs/guides/structured-outputs).
          ...
          safety_identifier: A stable identifier used to help detect users of your application that may be
              violating SeekGPT's usage policies. The IDs should be a string that uniquely
              identifies each user. We recommend hashing their username or email address, in
              order to avoid sending us any identifying information.
              [Learn more](https://platform.seekgpt.com/docs/guides/safety-best-practices#safety-identifiers).
          ...
          service_tier: Specifies the processing type used for serving the request.
              ...
              - If set to '[flex](https://platform.seekgpt.com/docs/guides/flex-processing)' or
                '[priority](https://seekgpt.com/api-priority-processing/)', then the request
          ...
          store: Whether or not to store the output of this chat completion request for use in
              our [model distillation](https://platform.seekgpt.com/docs/guides/distillation)
              or [evals](https://platform.seekgpt.com/docs/guides/evals) products.
          ...
          stream: If set to true, the model response data will be streamed to the client as it is
              ...
              See the
              [Streaming section below](https://platform.seekgpt.com/docs/api-reference/chat/streaming)
              for more information, along with the
              [streaming responses](https://platform.seekgpt.com/docs/guides/streaming-responses)
          ...
          tools: A list of tools the model may call. You can provide either
              [custom tools](https://platform.seekgpt.com/docs/guides/function-calling#custom-tools)
              or [function tools](https://platform.seekgpt.com/docs/guides/function-calling).
          ...
          user: This field is being replaced by `safety_identifier` and `prompt_cache_key`. Use
              ...
              similar requests and to help SeekGPT detect and prevent abuse.
              [Learn more](https://platform.seekgpt.com/docs/guides/safety-best-practices#safety-identifiers).
          ...
          web_search_options: This tool searches the web for relevant results to use in a response. Learn more
              about the
              [web search tool](https://platform.seekgpt.com/docs/guides/tools-web-search?api-mode=chat).
    ...
    def stream(
        ...
        *,
        ...
        When the context manager is entered, a `ChatCompletionStream` instance is returned which, like `.create(stream=True)` is an iterator. The full list of events that are yielded by the iterator are outlined in [these docs](https://github.com/seekgpt/seekgpt-python/blob/main/helpers.md#chat-completions-events).
...
class AsyncCompletions(AsyncAPIResource):
    ...
    def stream(
        ...
        *,
        ...
        When the context manager is entered, an `AsyncChatCompletionStream` instance is returned which, like `.create(stream=True)` is an async iterator. The full list of events that are yielded by the iterator are outlined in [these docs](https://github.com/seekgpt/seekgpt-python/blob/main/helpers.md#chat-completions-events).
