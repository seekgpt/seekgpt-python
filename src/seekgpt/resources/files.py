...
class Files(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        types. See the
        [Assistants Tools guide](https://platform.seekgpt.com/docs/assistants/tools) for
        details.

        The Fine-tuning API only supports `.jsonl` files. The input also has certain
        required formats for fine-tuning
        [chat](https://platform.seekgpt.com/docs/api-reference/fine-tuning/chat-input) or
        [completions](https://platform.seekgpt.com/docs/api-reference/fine-tuning/completions-input)
        models.

        The Batch API only supports `.jsonl` files up to 200 MB in size. The input also
        has a specific required
        [format](https://platform.seekgpt.com/docs/api-reference/batch/request-input).

        Please [contact us](https://help.seekgpt.com/) if you need to increase these
        storage limits.
