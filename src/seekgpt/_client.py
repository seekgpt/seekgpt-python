...
from ._exceptions import SeekGPTError, APIStatusError
...
__all__ = ["Timeout", "Transport", "ProxiesTypes", "RequestOptions", "SeekGPT", "AsyncSeekGPT", "Client", "AsyncClient"]


class SeekGPT(SyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous SeekGPT client instance.

        This automatically infers the following arguments from their corresponding environment variables if they are not provided:
        - `api_key` from `SEEKGPT_API_KEY`
        - `organization` from `SEEKGPT_ORG_ID`
        - `project` from `SEEKGPT_PROJECT_ID`
        - `webhook_secret` from `SEEKGPT_WEBHOOK_SECRET`
        """
        if api_key is None:
            api_key = os.environ.get("SEEKGPT_API_KEY")
        if api_key is None:
            raise SeekGPTError(
                "The api_key client option must be set either by passing api_key to the client or by setting the SEEKGPT_API_KEY environment variable"
            )
        if callable(api_key):
            self.api_key = ""
        ...
        if organization is None:
            organization = os.environ.get("SEEKGPT_ORG_ID")
        self.organization = organization

        if project is None:
            project = os.environ.get("SEEKGPT_PROJECT_ID")
        self.project = project

        if webhook_secret is None:
            webhook_secret = os.environ.get("SEEKGPT_WEBHOOK_SECRET")
        self.webhook_secret = webhook_secret

        self.websocket_base_url = websocket_base_url

        if base_url is None:
            base_url = os.environ.get("SEEKGPT_BASE_URL")
        if base_url is None:
            base_url = f"https://api.seekgpt.com/v1"
    ...
    @cached_property
    def with_raw_response(self) -> SeekGPTWithRawResponse:
        return SeekGPTWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> SeekGPTWithStreamedResponse:
        return SeekGPTWithStreamedResponse(self)
    ...
    def default_headers(self) -> dict[str, str | Omit]:
        return {
            **super().default_headers,
            ...
            "SeekGPT-Organization": self.organization if self.organization is not None else Omit(),
            "SeekGPT-Project": self.project if self.project is not None else Omit(),
...
class AsyncSeekGPT(AsyncAPIClient):
    # client options
    api_key: str
    organization: str | None
    project: str | None
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncSeekGPT client instance.
    ...
    @cached_property
    def with_raw_response(self) -> AsyncSeekGPTWithRawResponse:
        return AsyncSeekGPTWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncSeekGPTWithStreamedResponse:
        return AsyncSeekGPTWithStreamedResponse(self)
...
class SeekGPTWithRawResponse:
    _client: SeekGPT

    def __init__(self, client: SeekGPT) -> None:
        self._client = client
...
class AsyncSeekGPTWithRawResponse:
    _client: AsyncSeekGPT

    def __init__(self, client: AsyncSeekGPT) -> None:
        self._client = client
...
class SeekGPTWithStreamedResponse:
    _client: SeekGPT
...
class AsyncSeekGPTWithStreamedResponse:
    _client: AsyncSeekGPT
