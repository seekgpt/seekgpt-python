...
class ChatCompletionStream(Generic[ResponseFormatT]):
    ...
    https://platform.seekgpt.com/docs/api-reference/streaming
    """
...
class ChatCompletionStreamState(Generic[ResponseFormatT]):
    ...
    ```py
    from seekgpt.lib.streaming.chat import ChatCompletionStreamState
...
def _is_valid_chat_completion_chunk_weak(sse_event: ChatCompletionChunk) -> bool:
    ...
    # this is broken by the Azure SeekGPT in case of Asynchronous Filter enabled.
