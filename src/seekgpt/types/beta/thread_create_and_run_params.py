...
class ThreadCreateAndRunParamsBase(TypedDict, total=False):
    ...
    """
    The ID of the [Model](https://platform.seekgpt.com/docs/api-reference/models) to
    ...
    Compatible with [GPT-4o](https://platform.seekgpt.com/docs/models#gpt-4o),
...
class ThreadToolResourcesCodeInterpreter(TypedDict, total=False):
    ...
    """
    A list of [file](https://platform.seekgpt.com/docs/api-reference/files) IDs made
...
class ThreadToolResourcesFileSearchVectorStore(TypedDict, total=False):
    ...
    file_ids: SequenceNotStr[str]
    """
    A list of [file](https://platform.seekgpt.com/docs/api-reference/files) IDs to
...
class ThreadToolResourcesFileSearch(TypedDict, total=False):
    ...
    """
    The
    [vector store](https://platform.seekgpt.com/docs/api-reference/vector-stores/object)
...
class Thread(TypedDict, total=False):
    ...
    """
    A list of [messages](https://platform.seekgpt.com/docs/api-reference/messages) to
