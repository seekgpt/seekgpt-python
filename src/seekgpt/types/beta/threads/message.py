...
class Message(BaseModel):
    ...
    [assistant](https://platform.seekgpt.com/docs/api-reference/assistants) that
    ...
    """
    The ID of the [run](https://platform.seekgpt.com/docs/api-reference/runs)
    ...
    thread_id: str
    """
    The [thread](https://platform.seekgpt.com/docs/api-reference/threads) ID that
