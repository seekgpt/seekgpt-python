...
```python
from seekgpt.types import Completion, CompletionChoice, CompletionUsage
```

Methods:

- <code title="post /completions">client.completions.<a href="./src/seekgpt/resources/completions.py">create</a>(\*\*<a href="src/seekgpt/types/completion_create_params.py">params</a>) -> <a href="./src/seekgpt/types/completion.py">Completion</a></code>
...
```python
from seekgpt.types import ChatModel
```
...
```python
from seekgpt.types.chat import (
    ChatCompletion,
...
- <code title="post /chat/completions">client.chat.completions.<a href="./src/seekgpt/resources/chat/completions/completions.py">create</a>(\*\*<a href="src/seekgpt/types/chat/completion_create_params.py">params</a>) -> <a href="./src/seekgpt/types/chat/chat_completion.py">ChatCompletion</a></code>
