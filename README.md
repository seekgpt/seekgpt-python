...
for event in stream:
    print(event)
        The previous standard (supported indefinitely) for generating text is the [Chat Completions API](https://about.seekgpt.org/developer). You can use that API to generate text from the model with the code below.
